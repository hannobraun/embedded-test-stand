...
pub enum Error {
    ...
    TargetStartPwmSignal(TargetStartPwmSignalError),
...
impl From<TargetStartPwmSignalError> for Error {
    fn from(err: TargetStartPwmSignalError) -> Self {
        Self::TargetStartPwmSignal(err)
    }
}
